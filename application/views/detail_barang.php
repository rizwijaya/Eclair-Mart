                    ...
                    <div class="row align-items-stretch mb-4">
                        <div class="col-sm-5 pr-sm-0">
                            <div class="border d-flex align-items-center justify-content-between py-1 px-3 bg-white border-white"><span class="small text-uppercase text-gray mr-4 no-select">Quantity</span>
                                <div class="quantity">
                                    <form action="<?php echo base_url(); ?>pelanggan/tambahkeranjang_quantity/<?= $u->id_barang ?>" method="post">

                                        <input class="form-control border-0 shadow-0 p-0" name="jumlah" type="number" placeholder="1">
                            ...
                            <div class="d-block mb-3 position-relative"><a class="d-block" href="<?php echo base_url(); ?>pelanggan/detail_barang/<?php echo $brg->id_barang ?>"><img class="img-fluid w-100" src="<?php echo base_url(); ?>assets/assets_barang/image/<?php echo $brg->photo_barang ?>" alt="..."></a>
                                <div class="product-overlay">
                                    <ul class="mb-0 list-inline">
                                        <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark" href="filterbarang.php"><i class="far fa-heart"></i></a></li>
