              ...
              <div class="modal-content">
                  <div class="modal-body p-0">
                      <div class="row align-items-stretch">
                          <div class="col-lg-6 p-lg-0"><a class="product-view d-block h-100 bg-cover bg-center" style="background: url(<?php echo base_url(); ?>/assets/assets_home/img/product-5.jpg)" href="<?php echo base_url(); ?>/assets/assets_home/img/product-5.jpg" data-lightbox="productview" title="Red digital smartwatch"></a><a class="d-none" href="<?php echo base_url(); ?>/assets/assets_home/img/product-5-alt-1.jpg" title="Red digital smartwatch" data-lightbox="productview"></a><a class="d-none" href="<?php echo base_url(); ?>/assets/assets_home/img/product-5-alt-2.jpg" title="Red digital smartwatch" data-lightbox="productview"></a></div>
                          <div class="col-lg-6">
                              ...
                              <div class="position-relative mb-3">
                                  ...
                                  <div class="product-overlay">
                                      <ul class="mb-0 list-inline">
                                          ...
                                          <li class="list-inline-item mr-0"><a class="btn btn-sm btn-outline-dark" href="pelanggan/detail_barang/<?php echo $u->id_barang ?>" data-toggle="modal"><i class="fas fa-expand"></i></a></li>
                                      </ul>
                                  </div>
                              </div>
              ...
              <form action="#">
                <div class="row">
                  <div class="col-lg-12 form-group">
                    <label class="text-small text-uppercase" for="address">Nama Lengkap</label>
                    <input class="form-control form-control-lg" id="address" type="text" placeholder="Masukkan Nama Lengkap Anda">
                  </div>
                  <div class="col-lg-12 form-group">
                  ...
                  <div class="col-lg-12 form-group">
                    ...
                    <input class="form-control form-control-lg" id="addressalt" type="text" placeholder="+62 12345678">
                  </div>
                  <div class="col-lg-12 form-group">
